...
#ifndef CTRWSKDICCLFEATDET_H
#define CTRWSKDICCLFEATDET_H

#include "Wskd.h"

#define CmdWskdIcclFeatdetGetInfo CtrWskdIcclFeatdet::CmdGetInfo
#define CmdWskdIcclFeatdetGetCornerinfo CtrWskdIcclFeatdet::CmdGetCornerinfo

#define VecVWskdIcclFeatdetCommand CtrWskdIcclFeatdet::VecVCommand
#define VecVWskdIcclFeatdetFlgbufstate CtrWskdIcclFeatdet::VecVFlgbufstate
#define VecVWskdIcclFeatdetThdstate CtrWskdIcclFeatdet::VecVThdstate

/**
	* CtrWskdIcclFeatdet
	*/
class CtrWskdIcclFeatdet : public CtrWskd {

public:
	/**
		* VecVCommand (full: VecVWskdIcclFeatdetCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVFlgbufstate (full: VecVWskdIcclFeatdetFlgbufstate)
		*/
	...
	/**
		* VecVThdstate (full: VecVWskdIcclFeatdetThdstate)
		*/
	class VecVThdstate {
...
public:
	CtrWskdIcclFeatdet(UntWskd* unt);
