...
/******************************************************************************
 class CtrWskdIcicleFeatdet::VecVCommand
 ******************************************************************************/

uint8_t CtrWskdIcicleFeatdet::VecVCommand::getTix(
			const string& sref
		) {
...
string CtrWskdIcicleFeatdet::VecVCommand::getSref(
			const uint8_t tix
		) {
...
void CtrWskdIcicleFeatdet::VecVCommand::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrWskdIcicleFeatdet::VecVFlgbufstate
 ******************************************************************************/

uint8_t CtrWskdIcicleFeatdet::VecVFlgbufstate::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrWskdIcicleFeatdet::VecVFlgbufstate::getSref(
			const uint8_t tix
		) {
...
void CtrWskdIcicleFeatdet::VecVFlgbufstate::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrWskdIcicleFeatdet::VecVThdstate
 ******************************************************************************/

uint8_t CtrWskdIcicleFeatdet::VecVThdstate::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrWskdIcicleFeatdet::VecVThdstate::getSref(
			const uint8_t tix
		) {
	if (tix == IDLE) return("idle");
...
void CtrWskdIcicleFeatdet::VecVThdstate::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrWskdIcicleFeatdet
 ******************************************************************************/

CtrWskdIcicleFeatdet::CtrWskdIcicleFeatdet(
			UntWskd* unt
		) : CtrWskd(unt) {
};

uint8_t CtrWskdIcicleFeatdet::getTixVCommandBySref(
			const string& sref
		) {
	return VecVCommand::getTix(sref);
};

string CtrWskdIcicleFeatdet::getSrefByTixVCommand(
			const uint8_t tixVCommand
		) {
	return VecVCommand::getSref(tixVCommand);
};

void CtrWskdIcicleFeatdet::fillFeedFCommand(
			Feed& feed
		) {
	VecVCommand::fillFeed(feed);
};

Cmd* CtrWskdIcicleFeatdet::getNewCmd(
			const uint8_t tixVCommand
		) {
	Cmd* cmd = NULL;
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdSet() {
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdGetInfo() {
	Cmd* cmd = new Cmd(0x03, VecVCommand::GETINFO, Cmd::VecVRettype::STATSNG);

	cmd->addParRet("tixVFlgbufstate", Par::VecVType::TIX, CtrWskdIcicleFeatdet::VecVFlgbufstate::getTix, CtrWskdIcicleFeatdet::VecVFlgbufstate::getSref, CtrWskdIcicleFeatdet::VecVFlgbufstate::fillFeed);
	cmd->addParRet("tixVThdstate", Par::VecVType::TIX, CtrWskdIcicleFeatdet::VecVThdstate::getTix, CtrWskdIcicleFeatdet::VecVThdstate::getSref, CtrWskdIcicleFeatdet::VecVThdstate::fillFeed);
	cmd->addParRet("tkst", Par::VecVType::UINT32);

	return cmd;
};

void CtrWskdIcicleFeatdet::getInfo(
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdGetCornerinfo() {
...
void CtrWskdIcicleFeatdet::getCornerinfo(
			uint8_t& shift
			, uint8_t& scoreMin
			, uint8_t& scoreMax
		) {
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdSetCorner() {
...
void CtrWskdIcicleFeatdet::setCorner(
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdSetThd() {
...
void CtrWskdIcicleFeatdet::setThd(
...
Cmd* CtrWskdIcicleFeatdet::getNewCmdTriggerThd() {
	Cmd* cmd = new Cmd(0x03, VecVCommand::TRIGGERTHD, Cmd::VecVRettype::VOID);

	return cmd;
};

void CtrWskdIcicleFeatdet::triggerThd(
		) {
