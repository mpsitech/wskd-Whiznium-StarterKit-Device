# file checkout.sh
# checkout script for Wskd device access library sources, release ezdevwskd_mpbb (ubuntu cross-compilation)
...
cp ../../ezdevwskd/UntWskdMpbb/*.h $BUILDROOT/ezdevwskd/
cp ../../ezdevwskd/UntWskdMpbb/*.cpp $BUILDROOT/ezdevwskd/
