...
#ifndef CTRWSKDICCLCAMACQ_H
#define CTRWSKDICCLCAMACQ_H

#include "Wskd.h"

#define CmdWskdIcclCamacqGetGrrdinfo CtrWskdIcclCamacq::CmdGetGrrdinfo
#define CmdWskdIcclCamacqGetPvwinfo CtrWskdIcclCamacq::CmdGetPvwinfo

#define VecVWskdIcclCamacqCommand CtrWskdIcclCamacq::VecVCommand
#define VecVWskdIcclCamacqGrrdbufstate CtrWskdIcclCamacq::VecVGrrdbufstate
#define VecVWskdIcclCamacqPvwbufstate CtrWskdIcclCamacq::VecVPvwbufstate

/**
	* CtrWskdIcclCamacq
	*/
class CtrWskdIcclCamacq : public CtrWskd {

public:
	/**
		* VecVCommand (full: VecVWskdIcclCamacqCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVGrrdbufstate (full: VecVWskdIcclCamacqGrrdbufstate)
		*/
	...
	/**
		* VecVPvwbufstate (full: VecVWskdIcclCamacqPvwbufstate)
		*/
